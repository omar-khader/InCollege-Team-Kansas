identification division.
       ...
       search-for-user.
           ...
           *> Check if input contains a space (multiple words)
           move 0 to ws-spaces
           ...
           if FILESTAT-PROFILE = "00"
               perform until 1 = 2
                   ...
                   *> Enhanced search logic to handle single names
                   if ws-spaces > 0
                       *> Multi-word search - match both first and last name
                       ...
                       *> Single word search - match if it appears in either first OR last name
                       if function upper-case(function trim(temp-profile-firstname)) = 
