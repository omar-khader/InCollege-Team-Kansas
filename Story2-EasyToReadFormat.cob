identification division.
       program-id. Story2-EasyToReadFormat.
       ...
       procedure division.
      ******************************************************************
      * STORY 2: Easy-to-Read Profile Format
      * 
      * As a logged-in user, I want my profile to be displayed in an
      * easy-to-read format, so I can quickly understand my information.
      * 
      * Features:
      ...
      ******************************************************************
       main.
           ...
           perform display-formatted-profile
      ...
      *    STORY 2: Enhanced profile display with easy-to-read format
      ...
      *        STORY 2: Personal Information section with clear header
      ...
      *        STORY 2: About Me section with proper spacing
      ...
      *        STORY 2: Professional Experience with numbered entries and indentation
      ...
      *            STORY 2: Clear message when no experience entries exist
                   move " " to WS-DISPLAY
                   perform say
                   move "--- Professional Experience ---" to WS-DISPLAY
                   perform say
      ...
      *        STORY 2: Education section with consistent formatting
      ...
      *        STORY 2: Closing separator for clean visual end
               move " " to WS-DISPLAY
               perform say
               move "================================" to WS-DISPLAY
               perform say
...
parse-profile-line-complete.
       ...
       say.
      *    STORY 2: All screen output is written to InCollege-Output.txt
      *    This includes formatted profile display for easy verification
           display WS-DISPLAY
