...
test-apply-for-job.
    ...
    move "--- Applying for Job ---" to WS-DISPLAY
    perform say
    move spaces to WS-DISPLAY
    string "Job: " function trim(job-title) 
...
apply-for-job.
    move "Processing application..." to WS-DISPLAY
    perform say
    ...
    move "Application submitted successfully!" to WS-DISPLAY
    perform say
    .
